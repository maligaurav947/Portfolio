      ...
      <section className="main-project" id="project">
        ...
        <div className="main-project__card">
          <div className="main-project__card__items">
            <img
              src="https://github.com/maligaurav947/Portfolio/blob/master/img/maligaurav947-github-io-toy-shop-2022-09-13-08_34_29.png?raw=true"
              alt="Toy Shop"
            />
          ...
          <div className="main-project__card__items">
            <img
              src="https://github.com/maligaurav947/Portfolio/blob/master/img/maligaurav947-github-io-Bank-developer-2022-08-29-10_45_32.png?raw=true"
          ...
          <div className="main-project__card__items">
            <img
              src="https://github.com/maligaurav947/Portfolio/blob/master/img/maligaurav947-github-io-ShowCase-2022-08-29-10_41_31.png?raw=true"
              alt="Show Case"
            />
            <div className="main-project__card__items__text">
              <h4 className="main-project__card__items__text__title">
